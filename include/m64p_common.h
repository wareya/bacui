 ...
 *
 * This function initializes a plugin for use by allocating memory, creating
 * data structures, and loading the configuration data -- but gives the plugin
 * a pointer to a struct of core function pointers, rather than a lib handle.
*/
typedef m64p_error (*ptr_PluginStartupSoft)(void *, void *, void (*)(void *, int, const char *));
#if defined(M64P_PLUGIN_PROTOTYPES) || defined(M64P_CORE_PROTOTYPES)
EXPORT m64p_error CALL PluginStartupSoft(void *, void *, void (*)(void *, int, const char *));
#endif
